...
Offline (Batch) RL has recently gained more attention, e.g. \cite{Agarwal2019}, \cite{nair2020} (cf. \url{https://bair.berkeley.edu/blog/2019/12/05/bear}).
\begin{itemize}
...
\begin{itemize}
  \item Try to find a way to combine the work of \cite{Birbach2014} and the above mentioned works.
  \item The calibration can run offline (Since NeRFs are still computational expensive) but you can use real world data from Justin.  
\end{itemize}
