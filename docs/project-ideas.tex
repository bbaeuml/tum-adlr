...
% Lennard
\subsection{Planning in Latent Spaces}
Optimization-based path planners iteratively refine joint angle sequences to generate short, constraint-compliant paths. However, joint angles and robot geometry live in two fundamentally different geometries: the shortest path in configuration space rarely translates to natural motion in the workspace.
...
\begin{itemize}
    ...
    \item Leverage ML frameworks for GPU acceleration.
\end{itemize}
